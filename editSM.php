...
<head>
    ...
    <title>Edit Invitation Card – WEDÉ (SM)</title>
    <link
    ...
    <div class="editor-container">
        <div class="card-section">
            <div class="card-preview" id="card-area">
                <img class="card-bg" id="card-bg" src="imgs/SM1b.png" alt="Card background" />
                <div class="overlay-text" style="top:25%;font-size:14px;">Save the Date</div>
                <div class="overlay-text" style="top:35%;font-size:15px;">For the wedding of</div>
                <div class="overlay-text" style="top:50%;font-family:'Great Vibes', cursive;font-size:26px;">Sophia &
                    Liam</div>
                <div class="overlay-text" style="top:65%;font-size:13px;">June 10, 2026 – London</div>
        ...
        <div class="controls">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col"><label for="brideName">Bride Name</label><input type="text" id="brideName"
                            placeholder="Bride"></div>
                    <div class="col"><label for="groomName">Groom Name</label><input type="text" id="groomName"
                            placeholder="Groom"></div>
                </div>
                <div class="row">
            ...
            <input type="color" id="color-input" value="#2e3b2a" />
            ...
            <p class="note">Click any text to edit, move, resize, or recolor it — then save or download your card.</p>
        </div>
    </div>

    <script>
        let weddingData = JSON.parse(localStorage.getItem('wede_wedding_MD')) || {
            id: Date.now(),
            brideName: 'Sophia',
            groomName: 'Liam',
        ...
        window.addEventListener("DOMContentLoaded", () => {
            const selectedCard = localStorage.getItem("selected_card_MD");
        ...
        cardArea.querySelectorAll(".overlay-text").forEach(el => {
            ...
            el.addEventListener("click", () => {
                ...
                colorInput.value = el.style.color || "#2e3b2a";
            });
        });
        ...
        saveWeddingBtn.addEventListener("click", async () => {
            ...
            localStorage.setItem('wede_wedding_MD', JSON.stringify(weddingData));
            ...
            const selectedCard = localStorage.getItem("selected_card_MD") || 'SM1.png';
        ...
        function generateQRCode() {
            ...
            if (rsvpUrl) {
                new QRCode(qrContainer, {
                    text: rsvpUrl, width: 70, height: 70, colorDark: '#2e3b2a', colorLight: '#FFFFFF', correctLevel: QRCode.CorrectLevel.L
                });
            } else {
