...
$fallback_cards = [
    ['id' => 301, 'name' => 'Classic Elegance', 'image_url' => 'imgs/sR1.png'],
    ['id' => 302, 'name' => 'Modern Grace', 'image_url' => 'imgs/sR2.png']
];
...
<head>
    ...
    <title>Regular - Select Invitation</title>
...
<body>
    ...
    <p>Regular Package – Choose your favorite card design.</p>
    ...
    <script>
        ...
        document.getElementById('continue-btn').addEventListener('click', () => {
            ...
            if (selected) {
                localStorage.setItem('selected_card_reg', selected.dataset.card);
                window.location.href = 'editSR1.php';
            } else {
