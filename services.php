...
<section class="services-list-section">
    ...
    <div class="services-intro">
        ...
        <p>From floral design to menu planning and entertainment — we provide full wedding coordination tailored to your unique style and vision. Our team ensures every detail is perfect so your big day feels effortless, elegant, and unforgettable.</p>
    </div>
    <div class="services-grid">
        <div class="service-card">
            <img src="https://thumbs.dreamstime.com/b/wedding-photography-logo-set-modern-camera-marriage-design-logos-combining-style-themes-great-photographers-bridal-399343573.jpg" alt="Photography">
            <h3>Photography & Videography</h3>
            <p>Capture your most precious moments with professional photographers and cinematic video production.</p>
        </div>
        <div class="service-card">
            <img src="https://www.shutterstock.com/image-vector/minimalist-hand-drawn-food-beverages-260nw-2516147925.jpg" alt="Food">
            <h3>Custom Food Menus & Planning</h3>
            <p>We help you choose the best menu for your guests, tailored to your style and theme.</p>
        </div>
        <div class="service-card">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/039/222/118/small/square-and-circle-frame-decorated-with-tropical-green-leaves-flat-illustration-isolated-on-white-background-natural-border-for-invitation-card-free-vector.jpg" alt="Invitations">
            <h3>Invitations & Stationery Design</h3>
            <p>Elegant invitation cards, seating charts, and thank-you notes.</p>
        </div>
        <div class="service-card">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/017/122/700/small/music-instrument-concert-musician-tool-entertainment-detailed-green-dominant-color-icon-set-vector.jpg" alt="Music">
            <h3>Music & Entertainment</h3>
            <p>We help you choose the best entertainment for your guests to keep the party alive.</p>
        </div>
        <div class="service-card">
            <img src="https://png.pngtree.com/png-clipart/20220417/original/pngtree-renderings-of-mori-wedding-venue-png-image_7524270.png" alt="Decor">
            <h3>Decor & Venue Design</h3>
            <p>We help you choose the best decor and venue setup that matches your wedding vibe.</p>
        </div>
        <div class="service-card">
            <img src="https://www.shutterstock.com/image-vector/color-palette-20-shades-green-260nw-2589083733.jpg" alt="Theme">
            <h3>Theme & Color Consultation</h3>
            <p>Helping you choose color palettes, floral styles, and design elements.</p>
        </div>
        <div class="service-card">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/068/226/121/small/delicious-cake-with-matcha-on-plate-flat-icon-vector.jpg" alt="Cake">
            <h3>Cake & Dessert Table Design</h3>
            <p>Custom wedding cakes and dessert displays that look (and taste) amazing.</p>
        </div>
        <div class="service-card">
            <img src="https://img.freepik.com/free-vector/elegant-wedding-invitation-with-golden-frame-leaves_1361-2144.jpg" alt="RSVP">
            <h3>RSVP & Guest Count</h3>
            <p>We help you keep track of your guests efficiently and easily.</p>
        </div>
        <div class="service-card">
            <img src="https://media.istockphoto.com/id/1710895076/vector/event-management-solid-icon-set.jpg?s=612x612&w=0&k=20&c=-tmWNiDDcokRJJHo4dWoFfined41Q5_X3SKQYoe2v_s=" alt="Budget">
            <h3>Budget Management</h3>
            <p>Helping you plan and manage your wedding budget.</p>
        </div>
    </div>
</section>
...
<section class="faq-section">
    ...
    <div class="faq-container">
        <div class="faq-item">
            ...
            <div class="faq-answer">Our packages start from $5000 and vary depending on the required services. We offer a free consultation to determine the right package for your budget.</div>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer">Book a free consultation using the button above, and we'll send you a customized quote within 24 hours.</div>
        </div>
        <div class="faq-item">
            <div class="faq-question">Do you offer eco-friendly options?</div>
            <div class="faq-answer">Absolutely! We provide sustainable choices like reusable decor and seasonal local flowers.</div>
        </div>
        <div class="faq-item">
            <div class="faq-question">When should we start planning?</div>
            <div class="faq-answer">Ideally 12-18 months before the date, but we can organize a perfect wedding even in just 3 months!</div>
        </div>
    </div>
</section>
...
<section class="testimonials-section">
    ...
    <div class="testimonials-grid">
        <div class="testimonial-card">
            ...
            <div class="stars">★★★★★</div>
            <p>"WEDÉ made our day magical! The coordination was perfect and every detail exceeded our expectations."</p>
            <div class="author">— Sarah & Michael, 2025</div>
        </div>
        <div class="testimonial-card">
            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Emma & James" class="avatar">
            <div class="stars">★★★★★</div>
            <p>"A professional and friendly team that guided us every step of the way. Choosing WEDÉ was the best decision!"</p>
